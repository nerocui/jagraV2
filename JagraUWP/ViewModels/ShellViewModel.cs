...
namespace JagraUWP.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private ICommand _menuViewsTaskViewCommand;
        ...
        public ICommand MenuViewsTaskViewCommand => _menuViewsTaskViewCommand ?? (_menuViewsTaskViewCommand = new RelayCommand(OnMenuViewsTaskView));
        ...
        private void OnMenuViewsTaskView() => MenuNavigationHelper.UpdateView(typeof(TaskViewViewModel).FullName);
